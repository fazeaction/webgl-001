...
class Main extends AbstractApplication {
    ...
    constructor() {
        ...
        this.numParticles = 64; //power fo 2
    ...
    getInitialPosData() {
        ...
        for (let i = 0; i < (total * 3); i += 3) {
            data[i] = Math.random() * this.limitToBounce - this.limitToBounce * 0.5;
            data[i + 1] = Math.random() * this.limitToBounce - this.limitToBounce * 0.5;
            data[i + 2] = Math.random() * this.limitToBounce - this.limitToBounce * 0.5;
        }
